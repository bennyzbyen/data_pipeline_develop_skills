...
The handoff should preserve abnormal type, rule text, grain, source, output table, KPI name, source table/field, and aggregation logic. These facts should appear in `dev_doc.md` under `KPI / Calculation Logic`.
