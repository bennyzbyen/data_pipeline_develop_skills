...
description: Use when generating, reviewing, or modifying portable Python DataEngine/DataHub data synchronization project code from AI-readable development docs, especially COT yearly sync work with changing source tables, target tables, fields, rowkeys, period ranges, or runtime parameters.
---
